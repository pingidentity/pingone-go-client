...
// checks if the BadRequestError type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &BadRequestError{}
...
func (o *BadRequestError) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling BadRequestError", requiredProperty)
		}
	}
