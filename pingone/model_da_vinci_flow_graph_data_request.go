...
// SetMaxZoom gets a reference to the given float32 and assigns it to the MaxZoom field.
...
// SetMinZoom gets a reference to the given float32 and assigns it to the MinZoom field.
