...
func NewDaVinciFlowPolicyCollectionLinks(self JSONHALLink, environment JSONHALLink, davinciApplication JSONHALLink) *DaVinciFlowPolicyCollectionLinks {
	...
	this.DavinciApplication = davinciApplication
	return &this
}
...
func (o DaVinciFlowPolicyCollectionLinks) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["davinciApplication"] = o.DavinciApplication
...
func (o *DaVinciFlowPolicyCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v in model_da_vinci_flow_policy_collection__links.go", requiredProperty)
		}
	}
	...
	*o = DaVinciFlowPolicyCollectionLinks(varDaVinciFlowPolicyCollectionLinks)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "davinciApplication")
...
func (o DaVinciFlowPolicyCollectionLinks) LogValue() slog.Value {
	...
	logAttrs = append(logAttrs, slog.Any("davinciApplication", o.DavinciApplication))
