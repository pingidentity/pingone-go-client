...
type RequestFailedError struct {
	...
	Code                 RequestFailedErrorCode       `json:"code"`
	AdditionalProperties map[string]interface{}
}

type _RequestFailedError RequestFailedError
...
func (o *RequestFailedError) GetCode() RequestFailedErrorCode {
	if o == nil {
		var ret RequestFailedErrorCode
		return ret
	}
...
func (o RequestFailedError) MarshalJSON() ([]byte, error) {
...
func (o RequestFailedError) ToMap() (map[string]interface{}, error) {
...
func (o *RequestFailedError) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestFailedError := _RequestFailedError{}

	err = json.Unmarshal(data, &varRequestFailedError)

	if err != nil {
		return err
	}

	*o = RequestFailedError(varRequestFailedError)
...
func (o RequestFailedError) LogValue() slog.Value {
...
func (o RequestFailedError) Error() string {
...
type NullableRequestFailedError struct {
	value *RequestFailedError
	isSet bool
}

func (v NullableRequestFailedError) Get() *RequestFailedError {
	return v.value
}

func (v *NullableRequestFailedError) Set(val *RequestFailedError) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestFailedError) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestFailedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestFailedError(val *RequestFailedError) *NullableRequestFailedError {
	return &NullableRequestFailedError{value: val, isSet: true}
}

func (v NullableRequestFailedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestFailedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
