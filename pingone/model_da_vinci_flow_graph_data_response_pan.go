...
// checks if the DaVinciFlowGraphDataResponsePan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowGraphDataResponsePan{}

// checks if the DaVinciFlowGraphDataResponsePan type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowGraphDataResponsePan{}
...
type _DaVinciFlowGraphDataResponsePan DaVinciFlowGraphDataResponsePan
...
func NewDaVinciFlowGraphDataResponsePan(x float64, y float64) *DaVinciFlowGraphDataResponsePan {
	this := DaVinciFlowGraphDataResponsePan{}
	this.X = x
	this.Y = y
	return &this
}
...
func (o *DaVinciFlowGraphDataResponsePan) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling DaVinciFlowGraphDataResponsePan", requiredProperty)
		}
	}

	varDaVinciFlowGraphDataResponsePan := _DaVinciFlowGraphDataResponsePan{}

	err = json.Unmarshal(data, &varDaVinciFlowGraphDataResponsePan)

	if err != nil {
		return err
	}

	*o = DaVinciFlowGraphDataResponsePan(varDaVinciFlowGraphDataResponsePan)
...
type NullableDaVinciFlowGraphDataResponsePan struct {
	value *DaVinciFlowGraphDataResponsePan
	isSet bool
}
...
func NewNullableDaVinciFlowGraphDataResponsePan(val *DaVinciFlowGraphDataResponsePan) *NullableDaVinciFlowGraphDataResponsePan {
	return &NullableDaVinciFlowGraphDataResponsePan{value: val, isSet: true}
}
