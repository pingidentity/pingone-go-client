...
// checks if the DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem{}

// checks if the DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem{}

// DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem struct for DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem
type DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem struct {
...
type _DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem
...
func NewDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem(name string) *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem {
	this := DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem{}
	this.Name = name
	return &this
}
...
func (o *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) SetLabel(v string) {
	o.Label = &v
}
...
func (o *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) SetType(v string) {
	o.Type = &v
}
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) ToMap() (map[string]interface{}, error) {
...
func (o *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem := _DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem{}

	err = json.Unmarshal(data, &varDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem)

	if err != nil {
		return err
	}

	*o = DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem(varDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem)
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) LogValue() slog.Value {
...
type NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem struct {
	value *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem
	isSet bool
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) Get() *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem {
	return v.value
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) Set(val *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem(val *DaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) *NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem {
	return &NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem{value: val, isSet: true}
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataPropertiesSaveVariablesValueItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
