...
type AccessFailedError struct {
	...
	Code                 AccessFailedErrorCode        `json:"code"`
	AdditionalProperties map[string]interface{}
}

type _AccessFailedError AccessFailedError
...
func (o AccessFailedError) MarshalJSON() ([]byte, error) {
...
func (o AccessFailedError) ToMap() (map[string]interface{}, error) {
...
func (o *AccessFailedError) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessFailedError := _AccessFailedError{}

	err = json.Unmarshal(data, &varAccessFailedError)

	if err != nil {
		return err
	}

	*o = AccessFailedError(varAccessFailedError)
...
func (o AccessFailedError) LogValue() slog.Value {
...
func (o AccessFailedError) Error() string {
...
type NullableAccessFailedError struct {
	value *AccessFailedError
	isSet bool
}

func (v NullableAccessFailedError) Get() *AccessFailedError {
	return v.value
}

func (v *NullableAccessFailedError) Set(val *AccessFailedError) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessFailedError) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessFailedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessFailedError(val *AccessFailedError) *NullableAccessFailedError {
	return &NullableAccessFailedError{value: val, isSet: true}
}

func (v NullableAccessFailedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessFailedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
