...
// checks if the InternalServerErrorDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalServerErrorDetail{}

// checks if the InternalServerErrorDetail type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &InternalServerErrorDetail{}
...
type _InternalServerErrorDetail InternalServerErrorDetail
...
func NewInternalServerErrorDetail(code string, message string) *InternalServerErrorDetail {
	this := InternalServerErrorDetail{}
	this.Code = code
...
func (o *InternalServerErrorDetail) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling InternalServerErrorDetail", requiredProperty)
		}
	}

	varInternalServerErrorDetail := _InternalServerErrorDetail{}

	err = json.Unmarshal(data, &varInternalServerErrorDetail)

	if err != nil {
		return err
	}

	*o = InternalServerErrorDetail(varInternalServerErrorDetail)
...
type NullableInternalServerErrorDetail struct {
	value *InternalServerErrorDetail
	isSet bool
}
...
func NewNullableInternalServerErrorDetail(val *InternalServerErrorDetail) *NullableInternalServerErrorDetail {
	return &NullableInternalServerErrorDetail{value: val, isSet: true}
}
