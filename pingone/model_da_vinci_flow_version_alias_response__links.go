...
// checks if the DaVinciFlowVersionAliasResponseLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowVersionAliasResponseLinks{}

// checks if the DaVinciFlowVersionAliasResponseLinks type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowVersionAliasResponseLinks{}
...
type _DaVinciFlowVersionAliasResponseLinks DaVinciFlowVersionAliasResponseLinks
...
func NewDaVinciFlowVersionAliasResponseLinks(environment JSONHALLink, self JSONHALLink, flowVersion JSONHALLink) *DaVinciFlowVersionAliasResponseLinks {
	this := DaVinciFlowVersionAliasResponseLinks{}
...
// GetFlowVersionOk returns a tuple with the FlowVersion field value
// and a boolean to check if the value has been set.
...
func (o DaVinciFlowVersionAliasResponseLinks) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["flowVersion"] = o.FlowVersion
...
func (o *DaVinciFlowVersionAliasResponseLinks) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v in model_da_vinci_flow_version_alias_response__links.go", requiredProperty)
		}
	}

	varDaVinciFlowVersionAliasResponseLinks := _DaVinciFlowVersionAliasResponseLinks{}

	err = json.Unmarshal(data, &varDaVinciFlowVersionAliasResponseLinks)

	if err != nil {
		return err
	}

	*o = DaVinciFlowVersionAliasResponseLinks(varDaVinciFlowVersionAliasResponseLinks)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "flowVersion")
...
func (o DaVinciFlowVersionAliasResponseLinks) LogValue() slog.Value {
	...
	logAttrs = append(logAttrs, slog.Any("flowVersion", o.FlowVersion))
...
type NullableDaVinciFlowVersionAliasResponseLinks struct {
	value *DaVinciFlowVersionAliasResponseLinks
	isSet bool
}
...
func NewNullableDaVinciFlowVersionAliasResponseLinks(val *DaVinciFlowVersionAliasResponseLinks) *NullableDaVinciFlowVersionAliasResponseLinks {
	return &NullableDaVinciFlowVersionAliasResponseLinks{value: val, isSet: true}
}
