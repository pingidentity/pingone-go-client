...
// checks if the DaVinciApplicationCollectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciApplicationCollectionResponse{}

// checks if the DaVinciApplicationCollectionResponse type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciApplicationCollectionResponse{}
...
type _DaVinciApplicationCollectionResponse DaVinciApplicationCollectionResponse
...
func NewDaVinciApplicationCollectionResponse(links DaVinciApplicationCollectionResponseLinks, embedded DaVinciApplicationCollectionResponseEmbedded) *DaVinciApplicationCollectionResponse {
	this := DaVinciApplicationCollectionResponse{}
	this.Links = links
...
func (o *DaVinciApplicationCollectionResponse) GetLinks() DaVinciApplicationCollectionResponseLinks {
	if o == nil {
		var ret DaVinciApplicationCollectionResponseLinks
		return ret
	}
...
func (o *DaVinciApplicationCollectionResponse) GetEmbedded() DaVinciApplicationCollectionResponseEmbedded {
	if o == nil {
		var ret DaVinciApplicationCollectionResponseEmbedded
		return ret
	}
...
func (o *DaVinciApplicationCollectionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling DaVinciApplicationCollectionResponse", requiredProperty)
		}
	}

	varDaVinciApplicationCollectionResponse := _DaVinciApplicationCollectionResponse{}

	err = json.Unmarshal(data, &varDaVinciApplicationCollectionResponse)

	if err != nil {
		return err
	}

	*o = DaVinciApplicationCollectionResponse(varDaVinciApplicationCollectionResponse)
...
type NullableDaVinciApplicationCollectionResponse struct {
	value *DaVinciApplicationCollectionResponse
	isSet bool
}
...
func NewNullableDaVinciApplicationCollectionResponse(val *DaVinciApplicationCollectionResponse) *NullableDaVinciApplicationCollectionResponse {
	return &NullableDaVinciApplicationCollectionResponse{value: val, isSet: true}
}
