...
// checks if the DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode{}

// checks if the DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode{}
...
type _DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode
...
func NewDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode(id string) *DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode {
	this := DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode{}
	this.Id = id
	return &this
}
...
func (o *DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v in model_da_vinci_flow_policy_create_request_flow_distribution_success_node.go", requiredProperty)
		}
	}

	varDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode := _DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode{}

	err = json.Unmarshal(data, &varDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode)

	if err != nil {
		return err
	}

	*o = DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode(varDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode)
...
type NullableDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode struct {
	value *DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode
	isSet bool
}
...
func NewNullableDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode(val *DaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode) *NullableDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode {
	return &NullableDaVinciFlowPolicyCreateRequestFlowDistributionSuccessNode{value: val, isSet: true}
}
