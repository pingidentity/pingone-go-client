...
// checks if the DaVinciExportFlowVersionSubflowsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciExportFlowVersionSubflowsResponse{}

// checks if the DaVinciExportFlowVersionSubflowsResponse type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciExportFlowVersionSubflowsResponse{}
...
type _DaVinciExportFlowVersionSubflowsResponse DaVinciExportFlowVersionSubflowsResponse
...
func NewDaVinciExportFlowVersionSubflowsResponse(links DaVinciExportFlowVersionResponseLinks, environment DaVinciExportFlowVersionResponseEnvironment, flow DaVinciExportFlowVersionResponseFlow, publishedVersion float32, version float32) *DaVinciExportFlowVersionSubflowsResponse {
	this := DaVinciExportFlowVersionSubflowsResponse{}
	this.Links = links
...
func (o *DaVinciExportFlowVersionSubflowsResponse) GetEmbedded() []DaVinciExportFlowVersionResponse {
	if o == nil || IsNil(o.Embedded) {
		var ret []DaVinciExportFlowVersionResponse
		return ret
	}
	return o.Embedded
}
...
func (o *DaVinciExportFlowVersionSubflowsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling DaVinciExportFlowVersionSubflowsResponse", requiredProperty)
		}
	}

	varDaVinciExportFlowVersionSubflowsResponse := _DaVinciExportFlowVersionSubflowsResponse{}

	err = json.Unmarshal(data, &varDaVinciExportFlowVersionSubflowsResponse)

	if err != nil {
		return err
	}

	*o = DaVinciExportFlowVersionSubflowsResponse(varDaVinciExportFlowVersionSubflowsResponse)
...
type NullableDaVinciExportFlowVersionSubflowsResponse struct {
	value *DaVinciExportFlowVersionSubflowsResponse
	isSet bool
}
...
func NewNullableDaVinciExportFlowVersionSubflowsResponse(val *DaVinciExportFlowVersionSubflowsResponse) *NullableDaVinciExportFlowVersionSubflowsResponse {
	return &NullableDaVinciExportFlowVersionSubflowsResponse{value: val, isSet: true}
}
