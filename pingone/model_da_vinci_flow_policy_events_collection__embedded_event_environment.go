...
func (o *DaVinciFlowPolicyEventsCollectionEmbeddedEventEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v in model_da_vinci_flow_policy_events_collection__embedded_event_environment.go", requiredProperty)
		}
	}
