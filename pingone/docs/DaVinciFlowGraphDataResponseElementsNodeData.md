# DaVinciFlowGraphDataResponseElementsNodeData
...
`func (o *DaVinciFlowGraphDataResponseElementsNodeData) GetCapabilityClass() string`

GetCapabilityClass returns the CapabilityClass field if non-nil, zero value otherwise.

### GetCapabilityClassOk

`func (o *DaVinciFlowGraphDataResponseElementsNodeData) GetCapabilityClassOk() (*string, bool)`
...
`func (o *DaVinciFlowGraphDataResponseElementsNodeData) SetCapabilityClass(v string)`

SetCapabilityClass sets CapabilityClass field to given value.

### HasCapabilityClass

`func (o *DaVinciFlowGraphDataResponseElementsNodeData) HasCapabilityClass() bool`
...
GetLinterErrorOk returns a tuple with the LinterError field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
