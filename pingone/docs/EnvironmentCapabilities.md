...
**Links** | Pointer to [**EnvironmentCapabilitiesLinks**](EnvironmentCapabilitiesLinks.md) |  | [optional] 
**CanAddResources** | Pointer to **bool** |  | [optional] 
**CanAssignCustomRolesEverywhere** | Pointer to **bool** |  | [optional] 
**CanAssignUsersRoles** | Pointer to **bool** |  | [optional] 
**CanContactSupport** | Pointer to **bool** |  | [optional] 
**CanCreateConnections** | Pointer to **bool** |  | [optional] 
**CanCreateCustomDomain** | Pointer to **bool** |  | [optional] 
**CanPromoteToProd** | Pointer to **bool** |  | [optional] 
**CanSendMfaNotificationsOutsideWhitelist** | Pointer to **bool** |  | [optional] 
**CanSendPasswordManagementNotifications** | Pointer to **bool** |  | [optional] 
**CanSendVerificationFlowNotifications** | Pointer to **bool** |  | [optional] 
**CanUseAadhaar** | Pointer to **bool** |  | [optional] 
**CanUseAamva** | Pointer to **bool** |  | [optional] 
**CanUseAccountOwnership** | Pointer to **bool** |  | [optional] 
**CanUseAccountProtection** | Pointer to **bool** |  | [optional] 
**CanUseAccountTakeoverDetection** | Pointer to **bool** |  | [optional] 
**CanUseApiAccessManagement** | Pointer to **bool** |  | [optional] 
**CanUseApplicationPermissions** | Pointer to **bool** |  | [optional] 
**CanUseBotMaliciousDeviceDetection** | Pointer to **bool** |  | [optional] 
**CanUseCredentialSharingDetection** | Pointer to **bool** |  | [optional] 
**CanUseCredentials** | Pointer to **bool** |  | [optional] 
**CanUseCredentialsPushNotifications** | Pointer to **bool** |  | [optional] 
**CanUseCustomSchema** | Pointer to **bool** |  | [optional] 
...
**CanUseEditNotificationTemplate** | Pointer to **bool** |  | [optional] 
...
**CanUseIntelligence** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceAdvancedPredictors** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceAnonymousNetworkDetection** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceDataConsent** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceEditPolicyScores** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceGeoVelocity** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceLastTransactionOlderThan** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceLimitedCompositePredictor** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceNewDevicePredictor** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceProtect** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceReputation** | Pointer to **bool** |  | [optional] 
**CanUseIntelligenceRisk** | Pointer to **bool** |  | [optional] 
...
### NewEnvironmentCapabilitiesWithDefaults
...
SetCanUseAadhaar sets CanUseAadhaar field to given value.
...
GetCanUseCustomSchemaOk returns a tuple with the CanUseCustomSchema field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
GetCanUseEditNotificationTemplate returns the CanUseEditNotificationTemplate field if non-nil, zero value otherwise.
...
SetCanUseIdentityProviders sets CanUseIdentityProviders field to given value.
...
### GetCanUseIntelligenceGeoVelocity
...
GetCanUseOATHToken returns the CanUseOATHToken field if non-nil, zero value otherwise.
...
GetCanUseTotpOk returns a tuple with the CanUseTotp field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetCanUseVerifyPushNotifications sets CanUseVerifyPushNotifications field to given value.
...
### GetGetcanUseUniversalCaptureOk
