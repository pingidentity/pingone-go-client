...
// DaVinciConnectorApiService DaVinciConnectorApi service
type DaVinciConnectorApiService service
...
// Execute executes the request
func (a *DaVinciConnectorApiService) DeleteConnectorInstanceByIdExecute(r ApiDeleteConnectorInstanceByIdRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciConnectorApiService.DeleteConnectorInstanceById")
	if err != nil {
