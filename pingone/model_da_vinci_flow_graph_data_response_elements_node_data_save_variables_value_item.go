...
// checks if the DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem{}

// checks if the DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem{}

// DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem struct for DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem
type DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem struct {
...
type _DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem
...
func NewDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem(name string) *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem {
	this := DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem{}
	this.Name = name
	return &this
}
...
func (o DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
...
func (o DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) ToMap() (map[string]interface{}, error) {
...
func (o *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem := _DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem{}

	err = json.Unmarshal(data, &varDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem)

	if err != nil {
		return err
	}

	*o = DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem(varDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem)
...
func (o DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) LogValue() slog.Value {
...
type NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem struct {
	value *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem
	isSet bool
}

func (v NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) Get() *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem {
	return v.value
}

func (v *NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) Set(val *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem(val *DaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) *NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem {
	return &NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem{value: val, isSet: true}
}

func (v NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDaVinciFlowGraphDataResponseElementsNodeDataSaveVariablesValueItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
