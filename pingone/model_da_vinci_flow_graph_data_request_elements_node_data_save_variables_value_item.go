...
// checks if the DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem{}

// checks if the DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem{}

// DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem struct for DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem
type DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem struct {
...
type _DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem
...
func NewDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem(name string) *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem {
	this := DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem{}
	this.Name = name
	return &this
}
...
func (o *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) GetValue() string {
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) ToMap() (map[string]interface{}, error) {
...
func (o *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem := _DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem{}

	err = json.Unmarshal(data, &varDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem)

	if err != nil {
		return err
	}

	*o = DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem(varDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem)
...
func (o DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) LogValue() slog.Value {
...
type NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem struct {
	value *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem
	isSet bool
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) Get() *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem {
	return v.value
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) Set(val *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem(val *DaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) *NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem {
	return &NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem{value: val, isSet: true}
}

func (v NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDaVinciFlowGraphDataRequestElementsNodeDataSaveVariablesValueItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
