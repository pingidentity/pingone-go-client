...
// checks if the GeneralError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeneralError{}

// checks if the GeneralError type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &GeneralError{}
...
type _GeneralError GeneralError
...
func (o *GeneralError) UnmarshalJSON(data []byte) (err error) {
	varGeneralError := _GeneralError{}

	err = json.Unmarshal(data, &varGeneralError)

	if err != nil {
		return err
	}

	*o = GeneralError(varGeneralError)
