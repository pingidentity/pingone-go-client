...
// checks if the DaVinciFlowPolicyEventsCollectionLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowPolicyEventsCollectionLinks{}

// checks if the DaVinciFlowPolicyEventsCollectionLinks type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowPolicyEventsCollectionLinks{}
...
type _DaVinciFlowPolicyEventsCollectionLinks DaVinciFlowPolicyEventsCollectionLinks
...
func NewDaVinciFlowPolicyEventsCollectionLinks(self JSONHALLink, environment JSONHALLink) *DaVinciFlowPolicyEventsCollectionLinks {
	this := DaVinciFlowPolicyEventsCollectionLinks{}
	this.Self = self
...
func (o *DaVinciFlowPolicyEventsCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v in model_da_vinci_flow_policy_events_collection__links.go", requiredProperty)
		}
	}

	varDaVinciFlowPolicyEventsCollectionLinks := _DaVinciFlowPolicyEventsCollectionLinks{}

	err = json.Unmarshal(data, &varDaVinciFlowPolicyEventsCollectionLinks)

	if err != nil {
		return err
	}

	*o = DaVinciFlowPolicyEventsCollectionLinks(varDaVinciFlowPolicyEventsCollectionLinks)
...
type NullableDaVinciFlowPolicyEventsCollectionLinks struct {
	value *DaVinciFlowPolicyEventsCollectionLinks
	isSet bool
}
...
func NewNullableDaVinciFlowPolicyEventsCollectionLinks(val *DaVinciFlowPolicyEventsCollectionLinks) *NullableDaVinciFlowPolicyEventsCollectionLinks {
	return &NullableDaVinciFlowPolicyEventsCollectionLinks{value: val, isSet: true}
}
