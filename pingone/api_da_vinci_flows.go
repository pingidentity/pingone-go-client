...
*/
func (a *DaVinciFlowsApiService) DeleteVersionByIdUsingFlowId(ctx context.Context, environmentID uuid.UUID, flowID string, versionID string) ApiDeleteVersionByIdUsingFlowIdRequest {
	return ApiDeleteVersionByIdUsingFlowIdRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
// Execute executes the request
func (a *DaVinciFlowsApiService) DeleteVersionByIdUsingFlowIdExecute(r ApiDeleteVersionByIdUsingFlowIdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciFlowsApiService.DeleteVersionByIdUsingFlowId")
	if err != nil {
		return nil, &APIError{error: err.Error()}
	}
...
*/
func (a *DaVinciFlowsApiService) GetDetailsByFlowIdAndVersionId(ctx context.Context, environmentID uuid.UUID, flowID string, versionID string) ApiGetDetailsByFlowIdAndVersionIdRequest {
	return ApiGetDetailsByFlowIdAndVersionIdRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
func (a *DaVinciFlowsApiService) GetDetailsByFlowIdAndVersionIdExecute(r ApiGetDetailsByFlowIdAndVersionIdRequest) (*DaVinciFlowVersionDetailResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciFlowsApiService.GetDetailsByFlowIdAndVersionId")
	if err != nil {
		return localVarReturnValue, nil, &APIError{error: err.Error()}
	}
...
*/
func (a *DaVinciFlowsApiService) GetVersionByIdUsingFlowId(ctx context.Context, environmentID uuid.UUID, flowID string, versionID string) ApiGetVersionByIdUsingFlowIdRequest {
	return ApiGetVersionByIdUsingFlowIdRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
func (a *DaVinciFlowsApiService) GetVersionByIdUsingFlowIdExecute(r ApiGetVersionByIdUsingFlowIdRequest) (*DaVinciFlowVersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciFlowsApiService.GetVersionByIdUsingFlowId")
	if err != nil {
		return localVarReturnValue, nil, &APIError{error: err.Error()}
	}
...
*/
func (a *DaVinciFlowsApiService) GetVersionsByFlowId(ctx context.Context, environmentID uuid.UUID, flowID string) ApiGetVersionsByFlowIdRequest {
	return ApiGetVersionsByFlowIdRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
func (a *DaVinciFlowsApiService) GetVersionsByFlowIdExecute(r ApiGetVersionsByFlowIdRequest) (*DaVinciFlowVersionCollectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciFlowsApiService.GetVersionsByFlowId")
	if err != nil {
		return localVarReturnValue, nil, &APIError{error: err.Error()}
	}
...
*/
func (a *DaVinciFlowsApiService) ReplaceAliasByFlowIdAndVersionId(ctx context.Context, environmentID uuid.UUID, flowID string, versionID string) ApiReplaceAliasByFlowIdAndVersionIdRequest {
	return ApiReplaceAliasByFlowIdAndVersionIdRequest{
		ApiService:    a,
		ctx:           ctx,
		environmentID: environmentID,
...
func (a *DaVinciFlowsApiService) ReplaceAliasByFlowIdAndVersionIdExecute(r ApiReplaceAliasByFlowIdAndVersionIdRequest) (*DaVinciFlowVersionAliasResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DaVinciFlowsApiService.ReplaceAliasByFlowIdAndVersionId")
	if err != nil {
		return localVarReturnValue, nil, &APIError{error: err.Error()}
	}
