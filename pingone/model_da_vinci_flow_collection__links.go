...
// checks if the DaVinciFlowCollectionLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DaVinciFlowCollectionLinks{}

// checks if the DaVinciFlowCollectionLinks type satisfies the LogValuer interface at compile time
var _ slog.LogValuer = &DaVinciFlowCollectionLinks{}
...
type _DaVinciFlowCollectionLinks DaVinciFlowCollectionLinks
...
func NewDaVinciFlowCollectionLinks(environment JSONHALLink, self JSONHALLink) *DaVinciFlowCollectionLinks {
	this := DaVinciFlowCollectionLinks{}
...
func (o *DaVinciFlowCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	for _, requiredProperty := range requiredProperties {
		if _, exists := allProperties[requiredProperty]; !exists {
			return fmt.Errorf("no value given for required property %v when unmarshaling DaVinciFlowCollectionLinks", requiredProperty)
		}
	}

	varDaVinciFlowCollectionLinks := _DaVinciFlowCollectionLinks{}

	err = json.Unmarshal(data, &varDaVinciFlowCollectionLinks)

	if err != nil {
		return err
	}

	*o = DaVinciFlowCollectionLinks(varDaVinciFlowCollectionLinks)
...
type NullableDaVinciFlowCollectionLinks struct {
	value *DaVinciFlowCollectionLinks
	isSet bool
}
...
func NewNullableDaVinciFlowCollectionLinks(val *DaVinciFlowCollectionLinks) *NullableDaVinciFlowCollectionLinks {
	return &NullableDaVinciFlowCollectionLinks{value: val, isSet: true}
}
