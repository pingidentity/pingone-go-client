...
func PingOneEnvironmentEndpoint(topLevelDomain, environmentID string) oauth2.Endpoint {
	u := url.URL{
		Scheme: "https",
...
//
// The environmentID parameter should be a valid PingOne environment ID.
func PingOneEnvironmentExtendedEndpoint(topLevelDomain, environmentID string) ExtendedEndpoint {
	u := url.URL{
		Scheme: "https",
		Host:   "auth.pingone." + strings.TrimPrefix(topLevelDomain, "."),
	}
